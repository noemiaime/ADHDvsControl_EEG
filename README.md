...
6. model interpretation using feature importance and SHAP.
...
The channel names follow the international 10--20 EEG system.
...
The raw CSV dataset is not tracked by Git because it is a large file.
...
It also handles local extraction of the dataset from the `.zip` file.
...
```text
theta/beta ratio = theta power / beta power
```
...
The final output is a subject-level feature table saved in:
...
* boxplots of the features with the largest group differences;
* Mann-Whitney U tests;
* Cohen's d effect size;
* False Discovery Rate correction;
* regional and channel-level effect size heatmaps;
...
The best-performing feature set is selected using balanced accuracy.
...
This project is developed for the Computational Applications to Neuroscience course.
